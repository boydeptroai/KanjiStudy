...
public class MemberEntity {
	...
	public MemberEntity(int member_id, String member_firstname, String member_lastname, String member_email,
			String member_pass, String member_img, int category_id, boolean member_status) {
		super();
