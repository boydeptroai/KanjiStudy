...
public class TestEntity {
	...
	public TestEntity(int testps_id, String question, String option1, String option2, String option3, String option4,
			String optioncorrect, String optionuselect, int test_id) {
		super();
	...
	public int getTestps_id() {
		return testps_id;
	}

	public void setTestps_id(int testps_id) {
		this.testps_id = testps_id;
	}
