              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <ul class="nav child_menu">
                      <li><a href="Topicforward?pageid=1">Chủ đề</a></li>
                      <li><a href="#">Kanji mới</a></li>
                  </ul>
               
                  <li><a href="#"><i class="fa fa-desktop"></i> Ql Thanh vien </a></li>
                  
                  <li><a href="#"><i class="fa fa-table"></i> QL luyen tap </a></li>
                  
                  <li><a href="#"><i class="fa fa-bar-chart-o"></i> QL test </a></li>
